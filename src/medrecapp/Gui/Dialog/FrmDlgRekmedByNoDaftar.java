 ...
 */
public class FrmDlgRekmedByNoDaftar extends javax.swing.JDialog {
    ...
    /** Creates new form FrmDlgRekmedByNoDaftar */
    public FrmDlgRekmedByNoDaftar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(this);
        String noPendaftaran = FrmDlgRekMedByNoRm.NoDaftarRekmed;
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                FrmDlgRekmedByNoDaftar dialog = new FrmDlgRekmedByNoDaftar(new javax.swing.JFrame(), true);
